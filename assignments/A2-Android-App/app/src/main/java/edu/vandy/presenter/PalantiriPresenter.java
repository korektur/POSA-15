...
public class PalantiriPresenter
    ...
    private ThreadFactory mThreadFactory =
            new ThreadFactory() {
                ...
                public Thread newThread(Runnable runnable) {
                    ...
                    // you fill in here by replacing "return null"
                    // with the appropriate code.
                    return new BeingThread(runnable, mBeingCount.getAndIncrement(),
                            PalantiriPresenter.this);
                }
            };
    ...
    private void createAndExecuteBeingsTasks(int beingCount) {
        ...
        ThreadPoolExecutor executor = new ThreadPoolExecutor(beingCount, beingCount,
                10, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(beingCount), mThreadFactory);
